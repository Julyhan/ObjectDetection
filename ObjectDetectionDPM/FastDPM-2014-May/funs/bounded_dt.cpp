...
void	PM_type::bounded_dt( const Mat &vals, FLOATS_4 &defcoeff, Mat &M, Mat &Ix, Mat &Iy )
{
	...
	auto	*vPt = (float*)vals.data; auto vStep = vals.step1();
	auto	*mPt = (float*)M.data; auto mStep = M.step1();
	auto		*ixPt = (int*)Ix.data; auto ixStep = Ix.step1();
	auto		*iyPt = (int*)Iy.data; auto iyStep = Iy.step1();
	auto	*tmPt = (float*)tmpM.data; auto tmStep = tmpM.step1();
	auto		*tyPt = (int*)tmpIy.data; auto tyStep = tmpIy.step1();
