...
public:
	...
	void		detect(double largetimes, int labelname, string save_txt, Mat &img, float score_thresh = -FLOAT_INF, bool show_hints = true, bool show_img = true, string save_img = "");
